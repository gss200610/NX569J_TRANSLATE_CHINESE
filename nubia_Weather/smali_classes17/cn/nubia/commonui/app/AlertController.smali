...
.method private adjustPadding(ZZLandroid/view/ViewGroup;Landroid/view/ViewGroup;)V
    ...
    sget v7, Lcn/nubia/commonui/R$id;->nubia_button_bg:I
    ...
    .line 462
    .local v3, "nubiaButtonPanel":Landroid/view/View;
    iget-object v6, p0, Lcn/nubia/commonui/app/AlertController;->mWindow:Landroid/view/Window;

    sget v7, Lcn/nubia/commonui/R$id;->nubia_bold_divider:I
    ...
    .line 463
    .local v2, "nubiaBoldDivider":Landroid/view/View;
    if-eqz v2, :cond_0
    ...
    .line 472
    .end local v2    # "nubiaBoldDivider":Landroid/view/View;
    .end local v3    # "nubiaButtonPanel":Landroid/view/View;
    :cond_1
    ...
    sget v7, Lcn/nubia/commonui/R$dimen;->nubia_center_dialog_vertical_margin:I
    ...
    .line 485
    .local v5, "verMargin":I
    const/4 v6, 0x0

    const/4 v7, 0x0

    invoke-virtual {v1, v6, v5, v7, v5}, Landroid/widget/LinearLayout$LayoutParams;->setMargins(IIII)V
    ...
    iget-object v6, p0, Lcn/nubia/commonui/app/AlertController;->mMessage:Ljava/lang/CharSequence;
    ...
    invoke-virtual {v1, v6, v5, v7, v8}, Landroid/widget/LinearLayout$LayoutParams;->setMargins(IIII)V
    ...
    sget v7, Lcn/nubia/commonui/R$id;->nubia_title_content_divider:I
    ...
    .line 502
    .local v4, "nubiaDivider":Landroid/view/View;
    if-eqz v4, :cond_2
