...
# static fields
.field private static a:Lcom/loc/bp;
...
.method constructor <init>(IILjava/net/Proxy;)V
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Lcom/loc/bo;-><init>(IILjava/net/Proxy;Z)V
...
.method constructor <init>(IILjava/net/Proxy;Z)V
    ...
    invoke-direct/range {v0 .. v5}, Lcom/loc/bo;-><init>(IILjava/net/Proxy;ZB)V
...
.method private constructor <init>(IILjava/net/Proxy;ZB)V
    ...
    iput-boolean v0, p0, Lcom/loc/bo;->g:Z

    const-wide/16 v0, -0x1

    iput-wide v0, p0, Lcom/loc/bo;->h:J

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lcom/loc/bo;->i:J

    new-instance v0, Lcom/loc/bo$1;

    invoke-direct {v0, p0}, Lcom/loc/bo$1;-><init>(Lcom/loc/bo;)V

    iput-object v0, p0, Lcom/loc/bo;->l:Ljavax/net/ssl/HostnameVerifier;

    iput p1, p0, Lcom/loc/bo;->b:I

    iput p2, p0, Lcom/loc/bo;->c:I

    iput-object p3, p0, Lcom/loc/bo;->f:Ljava/net/Proxy;

    iput-boolean p4, p0, Lcom/loc/bo;->d:Z

    iput-object v2, p0, Lcom/loc/bo;->k:Lcom/loc/bl$a;
    ...
    iput-object v0, p0, Lcom/loc/bo;->j:Ljava/lang/String;
    :try_end_0
    ...
    iput-object v0, p0, Lcom/loc/bo;->e:Ljavax/net/ssl/SSLContext;
    :try_end_1
...
.method private a(Ljava/net/HttpURLConnection;)Lcom/loc/br;
    ...
    iget-object v5, p0, Lcom/loc/bo;->j:Ljava/lang/String;
    ...
    invoke-direct {v1, v4, v0}, Lcom/loc/k;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v1, v3}, Lcom/loc/k;->a(I)V
    ...
    invoke-direct {v5, v6, v0}, Lcom/loc/k;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_6
    sget-object v5, Lcom/loc/bo;->a:Lcom/loc/bp;

    if-eqz v5, :cond_7

    sget-object v5, Lcom/loc/bo;->a:Lcom/loc/bp;

    invoke-interface {v5}, Lcom/loc/bp;->a()V

    :cond_7
    new-instance v5, Lcom/loc/br;

    invoke-direct {v5}, Lcom/loc/br;-><init>()V

    invoke-virtual {v4}, Ljava/io/ByteArrayOutputStream;->toByteArray()[B

    move-result-object v7

    iput-object v7, v5, Lcom/loc/br;->a:[B

    iput-object v6, v5, Lcom/loc/br;->b:Ljava/util/Map;

    iget-object v6, p0, Lcom/loc/bo;->j:Ljava/lang/String;

    iput-object v6, v5, Lcom/loc/br;->c:Ljava/lang/String;

    iput-object v0, v5, Lcom/loc/br;->d:Ljava/lang/String;
    :try_end_b
    ...
    invoke-static {v0, v4, v6}, Lcom/loc/y;->a(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
...
.method private a(Ljava/lang/String;Ljava/util/Map;Z)Ljava/net/HttpURLConnection;
    ...
    iget-object v2, p0, Lcom/loc/bo;->k:Lcom/loc/bl$a;

    if-eqz v2, :cond_0

    iget-object v0, p0, Lcom/loc/bo;->k:Lcom/loc/bl$a;

    iget-object v2, p0, Lcom/loc/bo;->f:Ljava/net/Proxy;

    invoke-interface {v0}, Lcom/loc/bl$a;->a()Ljava/net/URLConnection;
    ...
    iget-object v0, p0, Lcom/loc/bo;->f:Ljava/net/Proxy;
    ...
    :cond_1
    :goto_0
    iget-boolean v1, p0, Lcom/loc/bo;->d:Z
    ...
    iget-object v2, p0, Lcom/loc/bo;->e:Ljavax/net/ssl/SSLContext;
    ...
    iget-object v2, p0, Lcom/loc/bo;->l:Ljavax/net/ssl/HostnameVerifier;
    ...
    :cond_2
    invoke-direct {p0, p2, v0}, Lcom/loc/bo;->a(Ljava/util/Map;Ljava/net/HttpURLConnection;)V
...
.method public static a(Lcom/loc/bp;)V
    .locals 0

    sput-object p0, Lcom/loc/bo;->a:Lcom/loc/bp;
...
.method private a(Ljava/util/Map;Ljava/net/HttpURLConnection;)V
    ...
    iget-object v1, p0, Lcom/loc/bo;->j:Ljava/lang/String;
...
.method final a(Ljava/lang/String;Ljava/util/Map;[B)Lcom/loc/br;
    ...
    :try_start_0
    invoke-direct {p0, p1, p2, v0}, Lcom/loc/bo;->a(Ljava/lang/String;Ljava/util/Map;Z)Ljava/net/HttpURLConnection;
    ...
    :cond_0
    invoke-direct {p0, v1}, Lcom/loc/bo;->a(Ljava/net/HttpURLConnection;)Lcom/loc/br;
    :try_end_0
    ...
    .catch Lcom/loc/k; {:try_start_0 .. :try_end_0} :catch_8
    ...
    invoke-direct {v0, v2}, Lcom/loc/k;-><init>(Ljava/lang/String;)V
...
.method final a(Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;Lcom/loc/bn$a;)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_1
    :try_start_0
    invoke-static {p3}, Lcom/loc/bo;->a(Ljava/util/Map;)Ljava/lang/String;
    ...
    invoke-direct {p0, v1, p2, v4}, Lcom/loc/bo;->a(Ljava/lang/String;Ljava/util/Map;Z)Ljava/net/HttpURLConnection;
    :try_end_0
    ...
    iget-wide v6, p0, Lcom/loc/bo;->i:J
    ...
    invoke-direct {v2, v3}, Lcom/loc/k;-><init>(Ljava/lang/String;)V

    invoke-interface {p4}, Lcom/loc/bn$a;->d()V
    ...
    iget-boolean v3, p0, Lcom/loc/bo;->g:Z
    ...
    iget-wide v4, p0, Lcom/loc/bo;->h:J
    ...
    iget-wide v4, p0, Lcom/loc/bo;->i:J

    iget-wide v6, p0, Lcom/loc/bo;->h:J
    ...
    invoke-interface {p4, v2, v4, v5}, Lcom/loc/bn$a;->a([BJ)V
    ...
    iput-wide v4, p0, Lcom/loc/bo;->i:J
    :try_end_2
    ...
    invoke-interface {p4, v4, v6, v7}, Lcom/loc/bn$a;->a([BJ)V
    :try_end_6
    ...
    :cond_b
    :try_start_9
    iget-boolean v2, p0, Lcom/loc/bo;->g:Z

    if-eqz v2, :cond_d

    invoke-interface {p4}, Lcom/loc/bn$a;->c()V
    :try_end_9
    ...
    :cond_d
    :try_start_c
    invoke-interface {p4}, Lcom/loc/bn$a;->b()V
    :try_end_c
