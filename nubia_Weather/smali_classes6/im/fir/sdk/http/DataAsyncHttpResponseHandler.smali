.class public abstract Lim/fir/sdk/http/DataAsyncHttpResponseHandler;
...
.method getResponseData(Lorg/apache/http/HttpEntity;)[B
    ...
    invoke-static {v0, v4, v1}, Lim/fir/sdk/http/DataAsyncHttpResponseHandler;->copyOfRange([BII)[B

    move-result-object v1

    invoke-virtual {p0, v1}, Lim/fir/sdk/http/DataAsyncHttpResponseHandler;->sendProgressDataMessage([B)V
    :try_end_1
    ...
    :try_start_2
    invoke-static {v2}, Lim/fir/sdk/http/AsyncHttpClient;->silentCloseInputStream(Ljava/io/InputStream;)V
...
.method protected handleMessage(Landroid/os/Message;)V
    ...
    invoke-super {p0, p1}, Lim/fir/sdk/http/AsyncHttpResponseHandler;->handleMessage(Landroid/os/Message;)V
    ...
    invoke-virtual {p0, v0}, Lim/fir/sdk/http/DataAsyncHttpResponseHandler;->onProgressData([B)V
    :try_end_0
...
.method public final sendProgressDataMessage([B)V
    ...
    invoke-virtual {p0, v0, v1}, Lim/fir/sdk/http/DataAsyncHttpResponseHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;

    move-result-object v0

    invoke-virtual {p0, v0}, Lim/fir/sdk/http/DataAsyncHttpResponseHandler;->sendMessage(Landroid/os/Message;)V
